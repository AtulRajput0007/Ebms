...
<div class="col-sm-6 mt-5  mx-3">
 ...
 <table class="table table-bordered">
  <tbody>
   ...
   <tr>
    ...
    <td>
     <?php if(isset($row['assign_driver'])) {echo $row['assign_driver']; }?>
    </td>
   </tr>
   <tr>
    <td>Student/Staff Sign</td>
    <td></td>
   </tr>
   <tr>
    <td>Bus Driver Sign</td>
    <td></td>
   </tr>
  </tbody>
 </table>
 <div class="text-center">
  ...
  <form class='d-print-none d-inline' action="work.php"><input class='btn btn-info' type='submit' value='Close'></form>
 </div>
</div>
