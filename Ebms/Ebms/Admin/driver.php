...
<div class="col-sm-9 col-md-10 mt-5 text-center">
  <!--Table-->
  <p class=" bg-dark text-white p-2">No. Of Bus Driver</p>
  <?php
...
if(isset($_REQUEST['delete'])){
  $sql = "DELETE FROM driver_tb WHERE empid = {$_REQUEST['id']}";
...
<div><a class="btn btn-info box" href="insertemp.php"><i class="fas fa-user-plus fa-2x"></i></a>
</div>
</div>
