...
<div class="container pt-5" id="registration">
  <u><h2 class="text-center text-weight-bold">Create User Account</u></h2>
  <div class="row mt-4 mb-4">
    <div class="col-md-6 offset-md-3">
      <form action="" class="shadow-lg p-4" method="POST">
        ...
        <div class="form-group">
          <i class="fas fa-unlock-alt"></i><label for="pass" class="pl-2 font-weight-bold">Current
        ...
        <em style="font-size:11px;">Note - By clicking Sign Up, you agree to our Terms, Data
