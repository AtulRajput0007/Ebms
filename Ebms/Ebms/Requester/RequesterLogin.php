...
<body>
  <div class="mb-3 text-center text-weight-bold mt-5" style="font-size: 50px;">
    <i class="fas fa-bus"></i>
    <span>E-Bus Pass Management System</span><br>
    <i class="fas fa-user-circle"></i><u><h2>User Login </h2></u>
  </div>
    ...
    <div class="row justify-content-center custom-margin">
      <div class="col-sm-6 col-md-4">
        <form action="" class="shadow-lg p-4" method="POST">
          ...
          <div class="form-group">
            <i class="fas fa-lock"></i><label for="pass" class="pl-2 font-weight-bold">Password</label><input type="password"
